...
| `$NIXOS_STATE_VERSION`      | see <https://search.nixos.org/options?show=system.stateVersion&query=system.StateVersion>                                                                                                | valid nixos state versions                                                                                                                                                                             | `24.11`                         |
...
| `$NIXOS_CONFIG`             | see <https://web.archive.org/web/20241016161340/https://www.mankier.com/8/nixos-rebuild#Environment-NIXOS_CONFIG>                                                                        | `""`                                                                                                                                                                                                   |
