...
* [Aliyun ECS](https://www.alibabacloud.com/product/ecs)
* [AWS Lightsail](https://aws.amazon.com/lightsail/)
* [Buyvm(Frantech)](https://buyvm.net)
...
Buyvm(Frantech) works without any issue.  You'll need to add your ssh key to the host either during
...
|Distribution|       Name      | Status    | test date| 
|------------|-----------------|-----------|----------| 
|Debian      | 11              |**success**|2022-12-28|  
|Ubuntu      | 20.04           |**success**|2022-12-28| 
|Ubuntu      | 22.04           |**success**|2022-12-28| 
...
Hetzner cloud works out of the box. be s
